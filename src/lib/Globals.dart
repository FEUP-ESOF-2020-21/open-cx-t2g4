...
TextStyle buttonTextStyle(){return TextStyle(color: darkMode ? Color.fromRGBO(0x6f, 0x6f, 0x6f, 1): Colors.white);}
...
Color buttonColor(){return (darkMode ? Color.fromARGB(255, 0x32, 0x32, 0x32) : Colors.deepPurpleAccent);}
